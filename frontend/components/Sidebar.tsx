...
import { LayoutDashboard, Package, ShoppingCart, Users, MapPin, LogOut, Shirt, Settings, ShoppingBag, Zap, ChevronRight, ChevronLeft, History, Ship, BookOpen, DollarSign, FileText, Percent, Wallet, Megaphone, Award, Facebook, Chrome, UserPlus, MessageCircle, Star } from 'lucide-react';
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'mercadolibre_reviews', label: 'ML — Opiniones', icon: Star, roles: [Role.ADMIN, Role.WAREHOUSE], color: 'yellow' },
      ]
    },
    {
      title: 'Marketing',
