        ...
        <div className="flex justify-center items-center gap-1 sm:gap-2 pt-2">
          <div className="flex items-center gap-1 rounded-2xl bg-slate-800/60 border border-slate-700/50 shadow-lg shadow-black/20 p-1.5">
            <button
              onClick={() => setOffset(0)}
              disabled={offset === 0}
              className="p-2.5 rounded-xl text-white/90 hover:bg-cyan-500/20 hover:text-cyan-400 disabled:opacity-35 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-white/90 transition-all duration-200"
