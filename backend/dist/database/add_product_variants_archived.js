...
exports.addProductVariantsArchived = addProductVariantsArchived;
const db_1 = require("./db");
function addProductVariantsArchived() {
    return __awaiter(this, void 0, void 0, function* () {
       ...
       WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'product_variants' AND COLUMN_NAME = 'archived'`);
            ...
            yield (0, db_1.execute)(`ALTER TABLE product_variants ADD COLUMN archived TINYINT(1) NOT NULL DEFAULT 0 AFTER sku`);
            console.log('[DB] Columna product_variants.archived agregada');
        }
        catch (e) {
            console.error('[DB] Error agregando product_variants.archived:', (e === null || e === void 0 ? void 0 : e.message) || e);
        }
    });
}
