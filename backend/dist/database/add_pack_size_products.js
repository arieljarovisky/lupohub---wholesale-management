...
const addPackSizeToProducts = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      `);
        ...
        const colMayorista = yield (0, db_1.query)(`SELECT 1 FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'products' AND COLUMN_NAME = 'mayorista_pack_size'`);
