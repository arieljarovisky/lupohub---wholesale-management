...
router.get('/imported/link-info', payments_controller_1.getImportedReceiptLinkInfo);
router.get('/invoice-outstanding', payments_controller_1.getInvoicesOutstandingHandler);
router.get('/order-outstanding', payments_controller_1.getOrdersOutstandingHandler);
router.post('/allocate-preview', payments_controller_1.postPaymentAllocatePreview);
...
router.patch('/:id/invoices', payments_controller_1.patchPaymentInvoices);
