...
const exportFacturasIibbCapital = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        for (const r of rows) {
            ...
            if (cbteTipo !== 1)
                continue;
            const cbte = `${letraFromCbte(cbteTipo)}${String((_a = r.punto_venta) !== null && _a !== void 0 ? _a : '').padStart(4, '0')}${String((_b = r.numero_desde) !== null && _b !== void 0 ? _b : '').padStart(8, '0')}`;
