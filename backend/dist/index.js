...
const publicationStockBundles_routes_1 = __importDefault(require("./routes/publicationStockBundles.routes"));
...
const userTasks_routes_1 = __importDefault(require("./routes/userTasks.routes"));
...
app.use('/api/publication-bundles', publicationStockBundles_routes_1.default);
