...
export const exportFacturasIibbCapital = async (req: Request, res: Response) => {
  try {
    const { desde, hasta, customerId } = req.query as {
      desde?: string;
      hasta?: string;
      customerId?: string;
    };
